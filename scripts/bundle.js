...
/******/ 	return __webpack_require__(__webpack_require__.s = "./scripts/app.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _commute_map__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./commute_map */ "./scripts/commute_map.jsx");



document.addEventListener("DOMContentLoaded", function () {
  react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_commute_map__WEBPACK_IMPORTED_MODULE_2__["default"], null), root);
});

/***/ }),

/***/ "./scripts/commute_map.jsx":
/*!*********************************!*\
  !*** ./scripts/commute_map.jsx ***!
  \*********************************/
...
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-dom */ "./node_modules/react-dom/index.js");
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_dom__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _util_map_util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./util/map_util */ "./scripts/util/map_util.js");
...
function (_React$Component) {
  _inherits(CommuteMap, _React$Component);

  function CommuteMap(props) {
    var _this;

    _classCallCheck(this, CommuteMap);
...
/* harmony default export */ __webpack_exports__["default"] = (CommuteMap);
...
var toLatLng = function toLatLng(geoJ) {
  var output = [];
  geoJ.forEach(function (arr1) {
    arr1.forEach(function (arr2) {
      arr2.forEach(function (arr3, idx) {
...
var parseCoords = function parseCoords(str) {
  str = str.split(" ");
  var lat = parseFloat(str[0].split("(")[1]);
  var lng = parseFloat(str[1].split(")")[0]);
  var latLng = new google.maps.LatLng(lng, lat);
  return latLng;
};

var parseUrlCoords = function parseUrlCoords(str) {
  str = str.split(" ");
  var lng = parseFloat(str[0].split("(")[1]);
  var lat = parseFloat(str[1].split(")")[0]);
  return "".concat(lat, ",").concat(lng);
};

var parseUrlCoordsLatLng = function parseUrlCoordsLatLng(latLng) {
  var lat = latLng.lat();
  var lng = latLng.lng();
  return "".concat(lat, ",").concat(lng);
};
...
var makeMatrixUrl = function makeMatrixUrl(originHash, destination) {
  var originQuery = "";
  originHash.forEach(function (subwayStop, idx) {
    if (idx !== originHash.length - 1) {
      originQuery += "".concat(parseUrlCoords(subwayStop.lngLat), "|");
    } else {
      originQuery += "".concat(parseUrlCoords(subwayStop.lngLat));
    }
  });
  destination = parseUrlCoordsLatLng(destination);
  return "https://maps.googleapis.com/maps/api/distancematrix/json?&origins=".concat(originQuery, "&destinations=").concat(destination, "&mode=transit&key=").concat(Object(_key__WEBPACK_IMPORTED_MODULE_0__["myKey"])());
};
...
/***/ "./scripts/util/map_util.js":
/*!**********************************!*\
  !*** ./scripts/util/map_util.js ***!
  \**********************************/
/*! exports provided: mapOpts */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "mapOpts", function() { return mapOpts; });
